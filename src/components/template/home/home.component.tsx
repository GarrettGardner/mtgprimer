...
import type { IPageTemplateHome } from "@/models";
import { Button, CircleLink, Container, Icon, Logo } from "@/components/common";

import styles from "./home.module.scss";

export const TemplateHome = (props: { pageTemplate: IPageTemplateHome }) => {
  return (
    <section className={styles.home}>
      <Container>
        ...
        <ul>
          {props.pageTemplate.latestFormats.map((latestFormat, key) => (
            <li key={key}>
              <CircleLink
        ...
        <p>
          <Button href="/directory">Full Format Directory</Button>
        </p>
      </Container>
    </section>
  );
